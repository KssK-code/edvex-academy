...
ALTER TABLE alumnos ADD COLUMN IF NOT EXISTS certificacion_pagada BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE alumnos ADD COLUMN IF NOT EXISTS demo_activa BOOLEAN NOT NULL DEFAULT true;
